...
def chat_server(database_path: str,
    ...
    try:
        ...
        if verbose:
            print(f"[ ] Message decrypted successful. Verifying message "
                  f"contents are a known RSA public key.")
        exists = key_exists(
